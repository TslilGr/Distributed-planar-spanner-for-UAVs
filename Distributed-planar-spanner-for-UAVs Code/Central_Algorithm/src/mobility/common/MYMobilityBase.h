...
#include "INETDefs.h"
#include "ModuleAccess.h" //here we define the module of the current node (host/drone)
#include "Coord.h"        //Coordinates header
#include "IMobility.h"    //used to emit asignal about mobilityStateChangedSignal
 ...
 * @author Daniel Willkomm, Andras Varga
 */
class MYMobilityBase : public cSimpleModule, public IMobility
{
  public:
    /**
    ...
    /** @brief Identifies this host in the MYIdealRadio module*/
    //MYIdealRadio *idealR;
  ...
  protected:
    ...
    ////////////////////////////////////////////////////////////////////////////
    virtual Coord calcMYDronePosition();
     ...
     */
    virtual void reflectIfOutside(Coord& targetPosition, Coord& speed, double angle); //was double& and coord& speed
    ...
    virtual int isAtNFZ(int x,int y);
};
