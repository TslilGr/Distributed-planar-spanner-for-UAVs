 ...
 * @author Andras Varga
 */
class MYLineSegmentsMobilityBase : public MYMovingMobilityBase
{
  protected:
...
public:
  ...
  protected:
    ...
    virtual Coord calculate_TP_Around_NFZ(int numOfNFZ, Coord badPosition);

  public:
    MYLineSegmentsMobilityBase();
};
