...
/**
 * Implements a MAC suitable for use with MYIdealRadio.
 *
 * See the NED file for details.
 */
class MYIdealWirelessMac : public WirelessMacBase, public cListener
{
  protected:
    ...
    // parameters
    int headerLength;       // MYIdealAirFrame header length in bytes
  ...
  public:
    MYIdealWirelessMac();
    virtual ~MYIdealWirelessMac();
    cDoubleHistogram *queue_length_hist;
    cOutVector *queue_length_vec;
